...
if "__main__" == __name__:
    ...
    parser.add_argument(
        ...
        "--yes",
        action="store_true",
        help="Use the supplied settings without waiting for another ENTER confirmation.",
    )
    # parser.add_argument(
    #     "-n",
    #     "--npc",
    ...
    confirmation = (
        "Settings supplied by the caller; continuing without another prompt."
        if args.yes
        else f'If you are sure about the settings, press {highlight("ENTER")} to continue, or {highlight("Ctrl-C")} to stop.'
    )
    print(
        textwrap.dedent(
            f"""
