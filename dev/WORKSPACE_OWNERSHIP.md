...
The authoritative product is the user-supplied Git checkout. BDO-AIO 2.3.1 is a hotfix candidate based on published v2.3.0 commit `52a62fb`; v2.3.0 remains the rollback release until runtime confirmation.
